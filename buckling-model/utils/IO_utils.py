...
class ModelInput(object):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "num_longitudinal": self.num_longitudinal,
            "width": self.width,
            "length": self.length,

            "t_panel": self.t_panel,
            "t_longitudinal_web": self.t_longitudinal_web,
            "t_longitudinal_flange": self.t_longitudinal_flange,

            "h_longitudinal_web": self.h_longitudinal_web,
            "w_longitudinal_flange": self.w_longitudinal_flange,

            "axial_force": self.axial_force,

            "mesh_plate": self.mesh_plate,
            "mesh_longitudinal_web": self.mesh_longitudinal_web,
            "mesh_longitudinal_flange": self.mesh_longitudinal_flange,
