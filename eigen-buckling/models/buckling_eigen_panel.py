...
e2 = createEdgeBounds(assembly, 'TempSet-7', boundary_list[0][1], boundary_regions[1])
e3 = createEdgeBounds(assembly, 'TempSet-8', boundary_list[0][2], boundary_regions[1])
