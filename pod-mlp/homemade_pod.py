...
# ---------------------------------------------------------------------------------------------------------
# PODS
U, s, Vt = svd(centered_snapshots, full_matrices=True)
print(f"Computed SVD on stress_field : Found {U.shape[0]} modes")
...
# Need to perform dimension reduction
num_modes = 10

U_reduced = U[:, :num_modes]
s_reduced = U[:num_modes]
