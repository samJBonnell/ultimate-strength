...
global_side_set_1, _ = get_nodes(assembly, instance_name='panel', bounds = [-panel.length / 2 + capture_offset, panel.length / 2 - capture_offset, -panel.width / 2 - capture_offset, l_web_locations[0] - 0.015, -capture_offset, capture_offset])
...
global_side_set_2, _ = get_nodes(assembly, instance_name='panel', bounds = [-panel.length / 2 + capture_offset, panel.length / 2 - capture_offset, l_web_locations[-1] + 0.015, panel.width / 2 + capture_offset, -capture_offset, capture_offset])
